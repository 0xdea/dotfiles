...
My dotfiles are currently managed with [GNU Stow](https://www.gnu.org/software/stow/). Each
top-level directory represents a "group" of configs, and you can "install" (by symlinking) the
