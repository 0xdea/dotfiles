...
# Monokai - Gnome Terminal color scheme install script for Base24
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#383830', '#f92672', '#a6e22e', '#fd971f', '#66d9ef', '#ae81ff', '#a1efe4', '#f5f4f1', '#49483e', '#f92672', '#a6e22e', '#f4bf75', '#66d9ef', '#ae81ff', '#a1efe4', '#f9f8f5']"
        ...
        dset cursor-foreground-color "'#383830'"
...
gset string palette "#383830:#f92672:#a6e22e:#fd971f:#66d9ef:#ae81ff:#a1efe4:#f5f4f1:#49483e:#f92672:#a6e22e:#f4bf75:#66d9ef:#ae81ff:#a1efe4:#f9f8f5"
...
gset string cursor-foreground-color "'#383830'"
